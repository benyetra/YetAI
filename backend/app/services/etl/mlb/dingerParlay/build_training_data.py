...
def build_training_data(
    ...
    if miss:
        ...
        df["PowerScore"] = df.groupby("year")["PowerScore"] \
...
if __name__=="__main__":
    ...
    p.add_argument("--pitcher_stats", required=True, help="pitcher_stats_all.csv or s3://...")
    p.add_argument("--park_factors",  required=True, help="park_factors.csv or s3://...")
    p.add_argument("--weather",       required=True, help="weather_normalized_full.csv or s3://...")
