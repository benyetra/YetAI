...
from app.models.fantasy_models import FantasyPlayer, FantasyPlatform, FantasyPosition, FantasyRosterSpot, FantasyTeam, FantasyLeague
                ...
                async with session.get(players_url) as players_response:
                    ...
                    for player_id in all_player_ids:
                        if player_id in all_players_data:
                            ...
                            existing_player = db.query(FantasyPlayer).filter(
                    ...
                    # Verify the data
                    roster_count = db.query(FantasyRosterSpot).join(FantasyTeam).filter(
                        FantasyTeam.league_id == league.id
                    ).count()
