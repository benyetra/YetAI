...
def test_run_joins_three_dashboards(monkeypatch):
    ...
    monkeypatch.setattr("app.services.etl.wnba.update_team_defense_stats.SessionLocal", lambda: mock_db)

    base = [{"TEAM_ID": 1, "TEAM_NAME": "T1", "DREB": 24.0, "STL": 6.0, "BLK": 3.5, "PF": 17.0}]
    defense = [{
        "TEAM_ID": 1, "TEAM_NAME": "T1",
        "OPP_PTS": 80.0, "OPP_AST": 18.0, "OPP_REB": 33.0, "OPP_OREB": 7.0,
        "OPP_FG_PCT": 0.43, "OPP_FG3_PCT": 0.32, "OPP_FG3M": 7.5,
        "OPP_FG3A": 23.0, "OPP_FTM": 13.0, "OPP_TOV": 11.5,
    }]
