...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_trade_recommendations_id"), table_name="trade_recommendations"
    )
    op.drop_table("trade_recommendations")
    op.drop_index(
        op.f("idx_recommendations_user_active"), table_name="fantasy_recommendations"
    )
    op.drop_index(
        op.f("ix_fantasy_recommendations_id"), table_name="fantasy_recommendations"
    )
    ...
    op.drop_index(
        op.f("idx_waiver_targets_league_week"), table_name="waiver_wire_targets"
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "buy_low_indicator", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "sell_high_indicator", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "value_volatility",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("player_values_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["fantasy_players.id"],
            name=op.f("player_values_player_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('fantasy_users_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.Column(
            "platform",
            postgresql.ENUM("SLEEPER", "YAHOO", "ESPN", name="fantasyplatform"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "last_sync", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="fantasy_users_user_id_fkey"
        ),
    ...
    op.create_index(
        op.f("idx_fantasy_user_platform"),
        "fantasy_users",
        ["user_id", "platform"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "situation_description", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column("target_reason", sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column(
            "suggested_fab_percentage",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("waiver_wire_targets_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["fantasy_players.id"],
            name=op.f("waiver_wire_targets_player_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("waiver_wire_targets_pkey")),
    )
    op.create_index(
        op.f("ix_waiver_wire_targets_id"), "waiver_wire_targets", ["id"], unique=False
    )
    op.create_index(
        op.f("idx_waiver_targets_league_week"),
        "waiver_wire_targets",
        ["league_id", "week"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("season", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "trend_type", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "role_change_indicator", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["fantasy_players.id"],
            name=op.f("player_trends_player_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "championship_contender", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["team_id"],
            ["fantasy_teams.id"],
            name=op.f("team_needs_analysis_team_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("team_needs_analysis_pkey")),
    )
    op.create_index(
        op.f("ix_team_needs_analysis_id"), "team_needs_analysis", ["id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "waiver_type", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column("waiver_budget", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
            "scoring_type", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "teams_data",
            postgresql.JSON(astext_type=sa.Text()),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("league_historical_data_league_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("league_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "current_owner_team_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "original_owner_team_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column("season", sa.INTEGER(), autoincrement=False, nullable=False),
        ...
        sa.Column(
            "trade_deadline", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["fantasy_teams.id"],
            name=op.f("draft_picks_current_owner_team_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("draft_picks_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["original_owner_team_id"],
            ["fantasy_teams.id"],
            name=op.f("draft_picks_original_owner_team_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "proposed_by_team_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "team1_gives",
            postgresql.JSON(astext_type=sa.Text()),
        ...
        sa.Column(
            "proposed_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "veto_deadline", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"], ["fantasy_leagues.id"], name="trades_league_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["proposed_by_team_id"],
            ["fantasy_teams.id"],
            name="trades_proposed_by_team_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["team1_id"], ["fantasy_teams.id"], name="trades_team1_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["team2_id"], ["fantasy_teams.id"], name="trades_team2_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "opponent", sa.VARCHAR(length=10), autoincrement=False, nullable=True
        ),
        sa.Column(
            "vegas_implied_total",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["fantasy_players.id"],
            name=op.f("player_projections_player_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("player_projections_pkey")),
    )
    op.create_index(
        op.f("ix_player_projections_id"), "player_projections", ["id"], unique=False
    )
    op.create_index(
        op.f("idx_projections_player_week"),
        "player_projections",
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('fantasy_teams_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("league_id", sa.INTEGER(), autoincrement=False, nullable=False),
        ...
        sa.Column(
            "owner_name", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"], ["fantasy_leagues.id"], name="fantasy_teams_league_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('fantasy_leagues_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.Column(
            "league_type",
            postgresql.ENUM("REDRAFT", "KEEPER", "DYNASTY", name="fantasyleaguetype"),
            autoincrement=False,
            nullable=True,
        ),
        ...
        sa.Column("waiver_budget", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
            "waiver_clear_days", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "roster_positions",
            postgresql.JSON(astext_type=sa.Text()),
        ...
        sa.ForeignKeyConstraint(
            ["fantasy_user_id"],
            ["fantasy_users.id"],
            name="fantasy_leagues_fantasy_user_id_fkey",
        ),
        sa.PrimaryKeyConstraint("id", name="fantasy_leagues_pkey"),
        postgresql_ignore_search_path=False,
    )
    op.create_index(
        op.f("ix_fantasy_leagues_id"), "fantasy_leagues", ["id"], unique=False
    )
    op.create_index(
        op.f("idx_fantasy_league_sync"),
        "fantasy_leagues",
        ["fantasy_user_id", "is_synced"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "recommendation_type",
            postgresql.ENUM(
                "START_SIT", "WAIVER_WIRE", "TRADE", name="recommendationtype"
            ),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.Column(
            "primary_player_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "secondary_player_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "confidence",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("fantasy_recommendations_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["primary_player_id"],
            ["fantasy_players.id"],
            name=op.f("fantasy_recommendations_primary_player_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["secondary_player_id"],
            ["fantasy_players.id"],
            name=op.f("fantasy_recommendations_secondary_player_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fantasy_recommendations_user_id_fkey")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("fantasy_recommendations_pkey")),
    )
    op.create_index(
        op.f("ix_fantasy_recommendations_id"),
        "fantasy_recommendations",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_recommendations_user_active"),
        "fantasy_recommendations",
        ["user_id", "is_active"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("league_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "requesting_team_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("trade_recommendations_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["requesting_team_id"],
            ["fantasy_teams.id"],
            name=op.f("trade_recommendations_requesting_team_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["target_team_id"],
            ["fantasy_teams.id"],
            name=op.f("trade_recommendations_target_team_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["trade_id"],
            ["trades.id"],
            name=op.f("trade_recommendations_trade_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("trade_recommendations_pkey")),
    )
    op.create_index(
        op.f("ix_trade_recommendations_id"),
        "trade_recommendations",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "transaction_type",
            postgresql.ENUM("ADD", "DROP", "TRADE", "WAIVER", name="transactiontype"),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.Column(
            "dropped_player_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "processed_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "created_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["added_player_id"],
            ["fantasy_players.id"],
            name=op.f("fantasy_transactions_added_player_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["dropped_player_id"],
            ["fantasy_players.id"],
            name=op.f("fantasy_transactions_dropped_player_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("fantasy_transactions_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["team_id"],
            ["fantasy_teams.id"],
            name=op.f("fantasy_transactions_team_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("fantasy_transactions_pkey")),
    )
    op.create_index(
        op.f("ix_fantasy_transactions_id"), "fantasy_transactions", ["id"], unique=False
    )
    op.create_table(
        "fantasy_matchups",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        ...
        sa.Column("week", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "matchup_id", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("team1_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column("team2_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("fantasy_matchups_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["team1_id"],
            ["fantasy_teams.id"],
            name=op.f("fantasy_matchups_team1_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["team2_id"],
            ["fantasy_teams.id"],
            name=op.f("fantasy_matchups_team2_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("fantasy_matchups_pkey")),
    )
    op.create_index(
        op.f("ix_fantasy_matchups_id"), "fantasy_matchups", ["id"], unique=False
    )
    op.create_table(
        "trade_evaluations",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["trade_id"], ["trades.id"], name=op.f("trade_evaluations_trade_id_fkey")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("trade_evaluations_pkey")),
    )
    op.create_index(
        op.f("ix_trade_evaluations_id"), "trade_evaluations", ["id"], unique=False
    )
    op.create_table(
        "player_analytics",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        ...
        sa.Column("season", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "game_date", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "opponent", sa.VARCHAR(length=10), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "special_teams_snaps", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "snap_percentage",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.Column(
            "team_total_targets", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "target_share",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.Column(
            "goal_line_carries", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "carry_share",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.Column(
            "yards_after_catch", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "team_pass_attempts", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "team_rush_attempts", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "team_red_zone_attempts", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "game_script",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.Column(
            "snaps_missed_injury", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "games_missed_season", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["fantasy_players.id"],
            name=op.f("player_analytics_player_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("player_analytics_pkey")),
    )
    op.create_index(
        op.f("ix_player_analytics_id"), "player_analytics", ["id"], unique=False
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["fantasy_players.id"],
            name=op.f("fantasy_roster_spots_player_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["team_id"],
            ["fantasy_teams.id"],
            name=op.f("fantasy_roster_spots_team_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("fantasy_roster_spots_pkey")),
    )
    op.create_index(
        op.f("ix_fantasy_roster_spots_id"), "fantasy_roster_spots", ["id"], unique=False
    )
    op.create_index(
        op.f("idx_roster_team_week"),
        "fantasy_roster_spots",
        ["team_id", "week"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "jersey_number", sa.VARCHAR(length=5), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "college", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "adp", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "ownership_percentage",
            sa.DOUBLE_PRECISION(precision=53),
    ...
    op.create_index(
        op.f("ix_fantasy_players_id"), "fantasy_players", ["id"], unique=False
    )
    op.create_table(
        "competitor_analysis",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "waiver_aggressiveness_score",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "avg_faab_spent_per_season",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "high_faab_bid_threshold",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "faab_conservation_tendency",
            sa.VARCHAR(length=20),
            autoincrement=False,
            nullable=True,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["league_id"],
            ["fantasy_leagues.id"],
            name=op.f("competitor_analysis_league_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["team_id"],
            ["fantasy_teams.id"],
            name=op.f("competitor_analysis_team_id_fkey"),
        ),
