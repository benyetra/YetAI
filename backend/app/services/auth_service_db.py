...
class AuthServiceDB:
    ...
    async def upgrade_subscription(
        self, user_id: int, tier: str, expires_at: datetime = None
    ) -> Dict:
        ...
        try:
            ...
            try:
                ...
                if expires_at:
                    ...
                    user.subscription_expires_at = datetime.utcnow() + timedelta(
                        days=30
                    )
    ...
    async def update_user(self, user_id: int, update_data: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    f"Successfully updated user {user_id}. New values: is_admin={user.is_admin}, subscription_tier={user.subscription_tier}"
                )
