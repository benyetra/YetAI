...
def upgrade():
    ...
    op.add_column(
        "users", sa.Column("sleeper_user_id", sa.String(length=255), nullable=True)
    )
    ...
    op.create_index(
        op.f("ix_sleeper_leagues_id"), "sleeper_leagues", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_sleeper_rosters_id"), "sleeper_rosters", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_sleeper_players_id"), "sleeper_players", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_sleeper_players_sleeper_player_id"),
        "sleeper_players",
        ["sleeper_player_id"],
        unique=True,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_sleeper_players_sleeper_player_id"), table_name="sleeper_players"
    )
