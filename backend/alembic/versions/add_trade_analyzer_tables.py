...
def upgrade():
    ...
    op.create_index(
        "idx_trades_league_status", "trades", ["league_id", "status"], unique=False
    )
    op.create_index(
        "idx_trades_teams", "trades", ["team1_id", "team2_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "evaluation_version", sa.String(length=10), nullable=True, default="1.0"
        ),
    ...
    op.create_index(
        "ix_trade_evaluations_id", "trade_evaluations", ["id"], unique=False
    )
    op.create_index(
        "idx_trade_evaluations_trade", "trade_evaluations", ["trade_id"], unique=False
    )
    ...
    op.create_index(
        "ix_trade_recommendations_id", "trade_recommendations", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_team_needs_analysis_id", "team_needs_analysis", ["id"], unique=False
    )
    op.create_index(
...
def downgrade():
    ...
    op.drop_index(
        "idx_trade_recommendations_active", table_name="trade_recommendations"
    )
