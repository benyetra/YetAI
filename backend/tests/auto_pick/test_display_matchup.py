...
def test_display_matchup_uses_team_vs_opponent_from_metadata():
    ...
    assert display_matchup_title(c) == "Mets vs Phillies"


def test_display_matchup_falls_back_to_selection():
    c = _cand()
    assert display_matchup_title(c) == "Christian Scott UNDER 4.5 strikeouts"
