...
TEAM_TIMEZONE = {
    'Arizona Diamondbacks': -7, 'Atlanta Braves': -5, 'Baltimore Orioles': -5,
    'Boston Red Sox': -5, 'Chicago Cubs': -6, 'Chicago White Sox': -6,
    'Cincinnati Reds': -5, 'Cleveland Guardians': -5, 'Colorado Rockies': -7,
    'Detroit Tigers': -5, 'Houston Astros': -6, 'Kansas City Royals': -6,
    'Los Angeles Angels': -8, 'Los Angeles Dodgers': -8, 'Miami Marlins': -5,
    'Milwaukee Brewers': -6, 'Minnesota Twins': -6, 'New York Mets': -5,
    'New York Yankees': -5, 'Oakland Athletics': -8, 'Philadelphia Phillies': -5,
    'Pittsburgh Pirates': -5, 'San Diego Padres': -8, 'San Francisco Giants': -8,
    'Seattle Mariners': -8, 'St. Louis Cardinals': -6, 'Tampa Bay Rays': -5,
    'Texas Rangers': -6, 'Toronto Blue Jays': -5, 'Washington Nationals': -5,
...
def compute_travel_fatigue(team_id, team_name, opponent_name,
                           is_home=True, target_date=None):
...
def get_travel_run_adjustment(team_id, team_name, opponent_name,
                               is_home=True, target_date=None):
