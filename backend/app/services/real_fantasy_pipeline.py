...
class RealFantasyPipeline:
    ...
    def _calculate_player_projection(
        ...
        weather_multiplier = self._get_weather_multiplier(
            position, weather_data, team, opponent
        )
    ...
    def _calculate_base_projection(
        self, position: str, stats: Dict, games_played: int
    ) -> float:
    ...
    def _get_weather_multiplier(
        self, position: str, weather_data: Dict, team: str, opponent: str
    ) -> float:
    ...
    def _calculate_confidence(
        self, injury_status: str, games_played: int, position: str
    ) -> int:
