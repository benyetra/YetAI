...
def populate_sleeper_players():
    ...
    try:
            ...
            if player_id in roster_player_ids:
                ...
                if not existing_player:
                    ...
                    sleeper_player = SleeperPlayer(
                        ...
                        depth_chart_position=safe_int(player_data.get('depth_chart_position')),
        ...
        for player in sample_players:
            name = player.full_name or f"{player.first_name or ''} {player.last_name or ''}".strip()
            print(f"  ID: {player.sleeper_player_id}, Name: {name}, Position: {player.position}, Team: {player.team}")
