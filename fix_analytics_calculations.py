#!/usr/bin/env python3
"""
Fix analytics calculations - populate missing derived fields
"""
import psycopg2
import os
...
def fix_analytics_calculations():
    """Calculate and populate missing analytics fields"""
    try:
        ...
        # Update derived fields based on existing data
        update_query = """
        ...
        print(f"✅ Updated {affected_rows} analytics records with calculated fields")
        ...
        print(f"Verification - Total: {verification[0]}, Floor: {verification[1]}, Ceiling: {verification[2]}, Boom Rate: {verification[3]}")
        ...
        print(f"Error fixing analytics calculations: {e}")
        return False

if __name__ == "__main__":
    print("Starting analytics calculations fix...")
    success = fix_analytics_calculations()

    if success:
        print("✅ Analytics calculations fixed successfully!")
    else:
        print("❌ Failed to fix analytics calculations")